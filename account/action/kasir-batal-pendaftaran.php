<?php
    ...
    $updateResepQuery = "UPDATE db_resep SET status = 0 where id_pendaftaran = $id_pendaftaran";
    mysqli_query($koneksi, $updateResepQuery);
    
    //update pendaftaran is paid
    $updatePendaftaranQuery = "UPDATE db_pendaftaran SET is_paid=0 WHERE no=$id_pendaftaran";
