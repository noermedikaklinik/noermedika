...
<tr>
    ...
    <td style="width:33%;padding:10px;">Email<br><input type="text" name="email" value="<?php echo "$akses[email]";?>" autocomplete="off" disabled></td>
</tr>
<tr>
    <td style="width:33%;padding:10px;" colspan=2>Alamat<br><input type="text" name="alamat" value="<?php echo "$akses[alamat]";?>" autocomplete="off" disabled></td> 
</tr>
<tr>
    <td style="width:33%;padding:10px;">Posisi<br><input type="text" name="jabatan" value="<?php echo "$akses[hak_akses]";?>" autocomplete="off" disabled></td> 
