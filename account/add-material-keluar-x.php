...
<form name="login" method="post" action="save-data" enctype="multipart/form-data">
    <input type="hidden" name="jenis" value="add-material-keluar">
...
<td height="40">&nbsp;</td></tr>  
<td width="100%" style="padding:10px;"><a href="mutasi-stock-material" tooltip="Kembali ke data stock material" flow="right"><i class="fa fa-arrow-left" style="color:grey;font-size:27px;"></i></a>  &nbsp; &nbsp; &nbsp; <font size="4" color="#5b8ff5"><b>Stock Bahan Baku Keluar</b></font></td>  
</table>

<div style="height:25px;"></div>

<table width="95%" align="center">
<td style="width:33%;padding:10px;">No Transaksi Bahan Baku Keluar
<br><input type="text" name="nota" autocomplete="off" value="<?php echo "MK-$code"; ?>" required></td> 
<td style="width:33%;padding:10px;">Tanggal Bahan Baku Keluar
<br><input type="date" name="tanggal" autocomplete="off" required></td> 
<td style="width:33%;padding:10px;">Jumlah Bahan Baku Keluar
