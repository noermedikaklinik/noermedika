...
if ($akses['hak_akses'] == "KASIR" or $akses["hak_akses"] == "APOTEKER" or $akses["hak_akses"] == "ASISTEN APOTEKER"){header ("Location:kasir?kategori_cust=UMUM&message=$message&alert=$alert");}
